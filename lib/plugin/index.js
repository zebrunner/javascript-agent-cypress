...
const registerZbrPlugin = (on, config) => {
  ...
  on('after:run', async (results) => {
    ...
    spinnies.add('testsDurationData', { text: `testsDurationData: ${testsDurationData}`});
    spinnies.add('testsData', { text: `testsData: ${testsData}` });
    spinnies.add('runId', { text: `runId: ${runId}`});
    ...
    if (testsDurationData) {
      ...
      spinnies.add('testsDurationData', { text: `Video splitter results: ${testsDurationData}`});
