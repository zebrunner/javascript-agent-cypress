      ...
      testsDurationData?.forEach(tests => {
        tests.forEach(async (test) => {
          ...
          if (test.videoFilePath && testsData?.get(test.uniqueId)) {
            ...
            promises.push({id: testsData.get(test.uniqueId).zbrTestId, value: sendVideo(test.videoFilePath, runId, testsData.get(test.uniqueId).zbrSessionId).then((result) => console.log(result))});
          } else {
