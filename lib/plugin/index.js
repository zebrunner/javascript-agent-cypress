      ...
      testsDurationData?.forEach(tests => {
        tests.forEach(async (test) => {
          ...
          if (test.videoFilePath && testsData?.get(test.uniqueId)) {
            promises.push(setTestStatus({...test, ...testsData.get(test.uniqueId)}));
            ...
            promises.push(sendVideo(test.videoFilePath, runId, testsData.get(test.uniqueId).zbrSessionId || storedSessionsId.get(test.uniqueId)));
          } else {
