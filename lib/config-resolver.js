...
class ConfigResolver {
  ...
  getNotifyOnEachFailure() {
    return this.getConfigVar('REPORTING_NOTIFICATION_NOTIFY_ON_EACH_FAILURE', 'notifications.notifyOnEachFailure', true);
  }

  getSummarySendingPolicy() {
    const sendingPolicyConfig = this.getConfigVar('REPORTING_NOTIFICATION_SUMMARY_SENDING_POLICY', 'notifications.summarySendingPolicy', true);
  ...
  getSlackChannels() {
    const slackChannels = this.getConfigVar('REPORTING_NOTIFICATION_SLACK_CHANNELS', 'notifications.slackChannels', true);
  ...
  getEmailRecipients() {
    const emails = this.getConfigVar('REPORTING_NOTIFICATION_EMAILS', 'notifications.emails', true);
