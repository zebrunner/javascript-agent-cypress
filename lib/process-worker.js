...
process.on('message', async (message) => {
  ...
  switch (event) {
    ...
    case EVENT_RUN_BEGIN: {
      ...
      console.log('fs.existsSync ..', fs.existsSync(path.join(__dirname, '..', 'cucumber-tag-expressions')));
      console.log('fs.existsSync ../..', fs.existsSync(path.join(__dirname, '../..', 'cucumber-tag-expressions')));
      console.log('fs.existsSync ../../..', fs.existsSync(path.join(__dirname, '../../..', 'cucumber-tag-expressions')));
      // if (fs.existsSync(path.join(__dirname, '../../', 'cucumber-tag-expressions'))) {
      //   console.log('cucumber-tag-expressions exist');
      // } else {
      //   console.log('cucumber-tag-expressions not exist');
      // }
      break;
    }
