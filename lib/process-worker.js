  ...
  switch (event) {
          ...
          .then(() => {
            ...
            zebrunnerApiClient.startTestSession(message.test, sessionId)
              .then(() => {
                ...
                const startRecPath = '/opt/zebrunner/cypress/start-capture-artifacts.sh';
    ...
    case EVENT_TEST_END: {
      ...
      if (sessionId) {
        ...
        const stopRecPath = '/opt/zebrunner/cypress/stop-capture-artifacts.sh';
      ...
      if (message.test.status.toLowerCase() === 'pending') {
        ...
        if (sessionId) {
          const uploadPath = '/opt/zebrunner/cypress/upload-artifacts.sh';
